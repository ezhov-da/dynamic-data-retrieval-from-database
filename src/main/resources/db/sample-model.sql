...
ALTER TABLE IF EXISTS "ORDER" DROP CONSTRAINT IF EXISTS FK_ORDER_REFERENCE_CUSTOMER;

ALTER TABLE IF EXISTS "ORDER_ITEM" DROP CONSTRAINT IF EXISTS FK_ORDERITE_REFERENCE_ORDER;

ALTER TABLE IF EXISTS "ORDER_ITEM" DROP CONSTRAINT IF EXISTS FK_ORDERITE_REFERENCE_PRODUCT;

ALTER TABLE IF EXISTS "PRODUCT" DROP CONSTRAINT IF EXISTS FK_PRODUCT_REFERENCE_SUPPLIER;
